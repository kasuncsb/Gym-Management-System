...
export default function Login() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            // Determine user type based on email convention or allow separate selector in future
            // For now, try 'member' first, then others if we had separate endpoints, 
            // but our backend unified login (technically services are separate).
            // Let's assume the user selects role or we infer it.
            // The current backend Controller `login` takes `userType`.

            let userType = 'member';
            const emailLower = email.toLowerCase();
            if (emailLower.includes('admin')) userType = 'staff'; // Map admin to staff with role='admin'?
            else if (emailLower.includes('manager')) userType = 'staff';
            else if (emailLower.includes('staff')) userType = 'staff';
            else if (emailLower.includes('trainer')) userType = 'trainer';
            ...
            if (userType === 'staff') {
                // Check specific staff role from response if available
                if (user.role === 'admin') router.push('/admin-dashboard');
                else if (user.role === 'manager') router.push('/manager-dashboard');
                else router.push('/staff-dashboard');
            } else if (userType === 'trainer') {
                router.push('/staff-dashboard'); // Or trainer dashboard
            } else {
                    ...
                    <div className="bg-white shadow-2xl border border-gray-200 overflow-hidden">
                        ...
                        <div className="px-8 py-10 text-center border-b border-gray-200">
                            ...
                            <p className="text-gray-600">
                                Sign in to your PowerWorld account
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit} className="px-8 py-8 space-y-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-10 pr-12 py-3 border border-gray-300 bg-white text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent transition-all duration-200"
                            ...
                            <div className="flex items-center justify-between">
                                <label className="flex items-center">
                                    <input
                                        ...
                                        className="h-4 w-4 text-red-500 focus:ring-red-500 border-gray-300 bg-white"
                                    />
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    type="button"
                                    className="w-full inline-flex justify-center py-3 px-4 border border-gray-300 bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors"
                                >
