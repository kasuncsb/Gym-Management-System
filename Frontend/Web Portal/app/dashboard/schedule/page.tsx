    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            selectedDate === day.date
                                ? "bg-red-700 border-red-600 text-white shadow-lg shadow-red-600/25 scale-105"
            ...
            <div className="grid gap-4">
                {filteredClasses.length > 0 ? (
                    filteredClasses.map((item) => (
                        ...
                        >
                            {/* Time Column */}
                            <div className="flex flex-col items-start min-w-[140px] border-l-2 border-red-600 pl-4 py-1">
                            ...
                            <div className="flex-1">
                                <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
                                    <div>
                                        <h3 className="text-xl font-bold text-white group-hover:text-red-500 transition-colors">{item.title}</h3>
                                    ...
                                    <button className="px-5 py-2 rounded-xl bg-white text-black font-semibold hover:bg-red-500 hover:text-white transition-all shadow-lg hover:shadow-red-600/30">
                                        Book Now
                                    </button>
                                </div>
            ...
            <div className="fixed bottom-8 right-8 md:hidden">
                <button className="w-14 h-14 bg-red-700 rounded-full flex items-center justify-center text-white shadow-xl shadow-red-700/30 hover:scale-110 transition-transform">
                    <Plus size={24} />
                </button>
            </div>
        </div>
