...
export function Navbar() {
    ...
    return (
        <nav className={cn(
            ...
            !mounted ? "bg-transparent border-transparent" : scrolled ? "bg-[#1e1e1e]/95 backdrop-blur-xl border-white/10 shadow-2xl shadow-red-900/5" : "bg-[#1e1e1e]/80 backdrop-blur-xl border-white/10"
        )}>
